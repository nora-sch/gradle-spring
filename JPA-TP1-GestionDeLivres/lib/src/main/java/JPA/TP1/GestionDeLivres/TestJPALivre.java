...
public class TestJPALivre extends LivreDAO{
	...
	public static void main(String[] args) throws DAOException {
		...
		Livre l3 = new Livre("Albert Camus", "L'étranger", 476); 
		...
		displayList("Liste des livres triés par titre ascendant : ", livreDao.findAllOrderByTitreAsc());
		displayList("Liste des livres triés par titre descendant : ", livreDao.findAllOrderByTitreDesc());
		...
		// delete		
		 ...
		 displayList("Liste des livres après la modification: ", livreDao.findAll());
	}
